pro make_3_profiles,species,platform,flightdates=flightdates,_extra=_extra
...
arctas_3_profiles,species,platform,flightdates=flightdates,mindata=mindata,maxdata=maxdata,unit=unit,_extra=_extra
