...
PRO seac4rs_model_merge, sourceDir, destDir, avgTime=avgTime, GridType=GridType
   ...
   DC8_flightdates = [ 20130806, 20130808, 20130812, 20130814, $ 
                       20130816, 20130819, 20130821, 20130823, $
                       20130826, 20130827, 20130830, 20130902, $
                       20130904, 20130906, 20130909, 20130911, $
                       20130913, 20130916 ]

   ; Flights on which the DC8 was airborne at 00 GMT - "2day flights"
   ; Replace DD with real date in the future.
   DC8_twoDay      = [ 20130806, 20130808, 20130826, 20130827, $
                       20130830, 20130906, 20130909, 20130911, $
		       20130916 ]
